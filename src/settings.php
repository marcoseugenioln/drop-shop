...
if (isset($_SESSION['user_id'])) 
{
	...
	$user = mysqli_fetch_assoc(mysqli_query($con, "SELECT * FROM user WHERE id='$user_id'"));
...
if (isset($_POST['changesettings'])) 
{
	...
	try 
	{
		...
		if($user_email != $email) 
		{
			if(mysqli_query($con, "UPDATE users SET  email='$email' WHERE user_id='$user_id'"))
			{
				//success message
				$success_message = 
				'
	...
	<div class="homepageheader">
		...
		<div class="categolis">
			<table>
				<tr>
					<th>
						<?php echo '<a href="mycart.php?uid='.$user.'" style="text-decoration: none;color: #040403;padding: 4px 12px;background-color: #fff;border-radius: 12px;">My Cart</a>'; ?>
					</th>
					...
					<th>
						<?php echo '<a href="settings.php?uid='.$user.'" style="text-decoration: none;color: #040403;padding: 4px 12px;background-color: #e6b7b8;border-radius: 12px;">Settings</a>'; ?>
					</th>
				</tr>
			</table>
		</div>
					...
					<div class="holecontainer" style=" padding-top: 20px; padding: 0 20%">
						<form action="" method="POST" class="registration">
							<div class="container signupform_content ">
								...
								<div>
									<tr>
										<?php echo '<input class="email signupbox" required type="email" name="email" placeholder="New Email" value="'.$user_email.'">'; ?>
									</tr></br>
								</div>
								<div>
									<tr>
										<input class="uisignupbutton signupbutton" type="submit" name="changesettings" value="Update Settings">
									</tr></br>
								</div>
								<div>
